...
function Project({ functionality, title, link, techUsed, image }) {
    ...
    return (
        <div className={hover ? "project col-xs-10 col-sm-8 col-md-5 my-5 col-lg-5 p-3 opacity-75" : "project col-xs-10 col-sm-8 col-md-5 my-5 col-lg-5 p-3"}
            ...
            <span style={hover ? {} : { display: 'none' }}>
                <h3 className='my-0' style={{ color: "black", fontWeight: "bold" }}>{title}
                    <a className='mx-4' href={link} target='_blank' style={{ textDecoration: "none" }}><BsGithub /></a>
                </h3>
                <p>{techUsed}</p>
